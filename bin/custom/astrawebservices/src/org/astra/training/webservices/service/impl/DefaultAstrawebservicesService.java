...
public class DefaultAstrawebservicesService implements AstrawebservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAstrawebservicesService.class);
	...
	{
		return DefaultAstrawebservicesService.class.getResourceAsStream("/astrawebservices/sap-hybris-platform.png");
	}
